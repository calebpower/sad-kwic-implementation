...
public class CircularShifterTest {
  ...
  @Test public void testTransform() {
    ...
    testInput.put(new Line("here's another test"), entries.get(0));
    testInput.put(new Line("blah blah third test"), entries.get(0));
    testInput.put(new Line("abcde 12345 67wx yz89"), entries.get(0));
    ...
    expectedOutput.put(new Line("is the first test this"), entries.get(1));
    expectedOutput.put(new Line("the first test this is"), entries.get(1));
    ...
    expectedOutput.put(new Line("blah blah third test"), entries.get(1));
    expectedOutput.put(new Line("blah third test blah"), entries.get(1));
    expectedOutput.put(new Line("third test blah blah"), entries.get(1));
    expectedOutput.put(new Line("test blah blah third"), entries.get(1));
    expectedOutput.put(new Line("abcde 12345 67wx yz89"), entries.get(1));
    expectedOutput.put(new Line("12345 67wx yz89 abcde"), entries.get(1));
    expectedOutput.put(new Line("67wx yz89 abcde 12345"), entries.get(1));
    expectedOutput.put(new Line("yz89 abcde 12345 67wx"), entries.get(1));
    
    Module module = new CircularShifter(testInput);
    module.transform();
