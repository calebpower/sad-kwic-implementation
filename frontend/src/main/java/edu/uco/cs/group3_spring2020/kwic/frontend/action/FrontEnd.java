package edu.uco.cs.group3_spring2020.kwic.frontend.action;
...
import edu.uco.cs.group3_spring2020.kwic.frontend.action.endpoint.api.GETSearchResultsEndpoint;
import edu.uco.cs.group3_spring2020.kwic.frontend.action.endpoint.api.POSTContentEndpoint;
import edu.uco.cs.group3_spring2020.kwic.frontend.action.endpoint.page.GETIndexPage;
...
public class FrontEnd implements Runnable {
   ...
   * @param searchContentHook the hook that will execute the user's query
   * @param setContentHook the hook that will set the content for future queries
   */
  public FrontEnd(int port, SearchContentHook searchContentHook, SetContentHook setContentHook) {
    this.port = port;
    ...
    endpoints = new Endpoint[] {
        new GETIndexPage(),
        new GETSearchResultsEndpoint().linkSearchContentHook(searchContentHook),
        new POSTContentEndpoint().linkSetContentHook(setContentHook)
      };
